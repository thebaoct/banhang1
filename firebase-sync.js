...
async function loadAllDataFromCloud() {
    ...
    try {
        ...
        // --- [FIX LỖI 2] GỘP KHÁCH HÀNG THAY VÌ ĐÈ TRẮNG ---
        ...
        cusSnap.forEach(d => cusMap.set(d.id, d.data())); // Dữ liệu Cloud ưu tiên
        localStorage.setItem('thebao_customers', JSON.stringify(Array.from(cusMap.values())));




        // --- [FIX LỖI 2] GỘP CÔNG NỢ THAY VÌ ĐÈ TRẮNG ---
        ...
        // --- [FIX LỖI 2] GỘP HOÁ ĐƠN (100 đơn Cloud gộp vào Local) ---
